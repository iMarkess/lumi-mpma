...
<title>Política de Privacidade — LUMI</title>
<style>
:root{--azul:#00458E}
...
<p>Aplicativo independente de denúncias</p></div></header>
<main class="wrap">
<p class="upd">Última atualização: julho de 2026.</p>
<p>A LUMI é um aplicativo <b>independente</b> para registro de denúncias — não é
canal oficial de nenhum órgão público. Esta política explica como tratamos seus
dados, em conformidade com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018 — LGPD).</p>
...
permitir o acompanhamento por protocolo e cumprir as atribuições legais do LUMI.</p>

<h2>3. Base legal</h2>
<p>O tratamento se fundamenta no cumprimento de obrigação legal e no exercício
regular de competências do serviço (art. 7º e art. 23 da LGPD).</p>

<h2>4. Compartilhamento</h2>
<p>Os dados são acessados internamente pela nossa equipe responsável. Não
...
controlado do LUMI, com acesso restrito.</p>

<h2>6. Retenção</h2>
<p>Os dados são mantidos pelo prazo necessário à apuração e conforme a tabela de
temporalidade e as normas aplicáveis.</p>

<h2>7. Direitos do titular</h2>
<p>Você pode solicitar confirmação, acesso, correção e, quando cabível, exclusão dos
seus dados, bem como informações sobre o tratamento, pelos canais da central de atendimento do app.</p>

<h2>8. Contato</h2>
<p>Fale com a gente pela central de atendimento do aplicativo.</p>

<h2>9. Alterações</h2>
<p>Esta política pode ser atualizada. A versão vigente estará sempre disponível
neste endereço.</p>

<footer>© LUMI — aplicativo independente. Documento fornecido para
fins de conformidade da Google Play. Recomenda-se validação por um profissional jurídico.</footer>
</main></body></html>`;
});
