    ...
    return _SettingsScaffold(
      ...
      child: _card(context, const [
        ...
        PrefSwitch(
          ...
          subtitle: 'Pendências e comunicados do MPMA.',
      ...
      child: Column(
        ...
        children: [
          ...
          _infoBox(context, Icons.gavel_rounded,
              'Tratamos seus dados conforme a LGPD (Lei 13.709/2018). Você pode solicitar exclusão a qualquer momento pela Ouvidoria do MPMA.'),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Image.asset('assets/images/lumi_logo.png', height: 84),
          ),
          const SizedBox(height: 16),
          Text('LUMI', style: t.headlineSmall),
          Text('Ministério Público do Estado do Maranhão',
              style: t.bodySmall, textAlign: TextAlign.center),
          const SizedBox(height: 4),
          Text('Versão 1.0.0', style: t.labelSmall),
          const SizedBox(height: 20),
          Text(
            'A LUMI é o canal oficial de denúncias do MPMA. Denuncie com segurança e sigilo, e acompanhe o andamento pelo número de protocolo.',
            style: t.bodyMedium,
